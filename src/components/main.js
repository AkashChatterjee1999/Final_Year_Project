            ...
            <div className="mainComponent">
                ...
                <div className="rightSidebar">
                    <div className="rightSidebar_header">
                    {
                        ...
                        <ChatHeader 
                            roboName={this.state.userName} 
                            roboIcon = {this.state.userArr[this.state.selectedId-1].icon} 
                            userId={this.state.selectedId} 
                            algo={this.state.userArr[this.state.selectedId-1].algo}>
                        </ChatHeader>
                        :null
                    }
                    </div>
                    {
                        this.state.selectedId>0?
                            <div className="rightSidebar_body">
                                <MessageBody 
                                    userArr={this.state.userArr[this.state.selectedId-1]} 
                                    roboIcon = {this.state.userArr[this.state.selectedId-1].icon} 
                                    userId={this.state.selectedId} 
                                    sentMessages={this.handleSentMessages} 
                                    botMessages={this.handleBotMessages} 
                                    replaceBlankWithBotReply={this.replaceBlankWithBotReply}>
                                </MessageBody>
                            </div>
                        :   <div className = "rightSidebar_body">
